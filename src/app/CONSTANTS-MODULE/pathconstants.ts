export class Pathconstants {
    ...
    public static readonly TrainingDB_Post ='TrainingDB/SaveTrainingDB' // Controller Name/Method Name
    public static readonly TrainingDB_GET ='TrainingDB/GetTrainingDB' // Controller Name / Method Name 
 
    public static readonly StateMaster_Post ='StateMasterDB/Savestatemaster' // Controller Name/Method Name

    public static readonly StateMasterDB_GET ='StateMasterDB/GetStateMaterDB' // Controller Name / Method Name
    
    public static readonly countrymaster_Get='CountrymasterContoller/GetCountrymaster'

    public static readonly CityMaster_Post ='CityMasterController/SaveCityMasterDB' // Controller Name/Method Name

    public static readonly CityMasterDB_GET ='CityMaster/GetcitymasterDB' // Controller Name / Method Name 
